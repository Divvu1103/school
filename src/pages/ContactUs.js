...
const ContactUs = () => {
  return (
    <div className=" p-4">
      ...
      <div className="flex flex-wrap  gap-y-3 items-center content-center place-content-center w-[90vw] h-full ">
        <div className="flex border w-2/5  border-slate-300 flex-col gap-y-3">
        ...
        <div className="flex w-2/5  gap-y-4 flex-col">
          <div className="bg-[#f1f1f1] p-3  h-1/2">
